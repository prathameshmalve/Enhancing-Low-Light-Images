...
folder_path = r"D:\ML projects\Enhancing-Low-light-images\low light samples"
...
def Sharp_Img():
    ...
    with tqdm(total=total_images, desc="Processing images") as pbar:
        ...
        for i, file_name in enumerate(image_files):
            ...
            output_path=r'D:\ML projects\Enhancing-Low-light-images\enhanced_parameter_tuning'
